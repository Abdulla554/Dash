...
const Row2 = () => {
  ...
  return (
    <Stack direction={"row"} flexWrap={"wrap"} gap={1.2} mt={1.3}>
      {/*900 اكبر عرض يوصل اله 900 يعني الحاله الطبيعيه مالته    اقل من */}
      ...
      <Box
        sx={{
          ...
          overflow: "auto",
          borderRadius: "4px",
// اقل عرض يوصل اله 280يعني بل حاله الطبعيعه اكبر من 280
          minWidth: "280px",
          // اكبر طول يوصل اله 555 ف الحاله الطبيعيه اقل من  555
          maxHeight: 555,
          flexGrow: 1,
        }}
      >
